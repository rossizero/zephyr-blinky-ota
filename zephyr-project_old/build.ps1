...
# --- Configuration ---
$Board = "esp32_devkitc_esp32_proccpu"
$SigningKeyFile = "root-rsa-2048.pem"
# --- End Configuration ---
...
$appCmd = "west build -p auto -b $Board -d $BuildDirApp . -- `
    -DESP32_BOOT_PARTITION_TABLE=`"boards/$($Board).yml`""
...
$mergeCmd = "esptool.py --chip esp32 merge_bin -o $MergedImage 0x1000 $BootloaderBin 0x8000 $PartitionsBin 0x10000 $McubootBin 0x20000 $AppBin"
...
if ($Flash) {
    ...
    $flashCmd = "esptool.py --chip esp32 --port $COMPort --baud 921600 write_flash 0x1000 $MergedImage"
